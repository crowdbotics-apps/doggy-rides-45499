"""
Django settings for doggy_rides_45499 project.
...
ROOT_URLCONF = 'doggy_rides_45499.urls'
...
WSGI_APPLICATION = 'doggy_rides_45499.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "doggy_rides_45499 API",
    "DESCRIPTION": "API documentation for doggy_rides_45499 App",
    "VERSION": "v1",
}
